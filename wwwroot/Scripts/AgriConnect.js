...
import { MarkResizable, SetOptional, Lazy, GetOptional, CreateFuncWithArgs, DeleteEmptyFields, Create as Create_2 } from "./WebSharper.Core.JavaScript/Runtime.js"
function isIDisposable(x){
  return"Dispose"in x;
}
function Main(){
  const viewMap=Map((page) => page.$==1?MarketView():page.$==2?DashboardView():page.$==3?PaymentsView():HomeView(), CurrentPage().View);
  const isActive=(p1, p2) => Equals(p1, p2)?"active":"";
  const C=Doc.EmbedView(viewMap);
  const P=Map((p_1) => isActive(p_1, Payments), CurrentPage().View);
  const D=Map((p_1) => isActive(p_1, Dashboard), CurrentPage().View);
  const M=Map((p_1) => isActive(p_1, Market), CurrentPage().View);
  const H=Map((p_1) => isActive(p_1, Home), CurrentPage().View);
  const N=tr("Payments", "\u0e81\u0eb2\u0e99\u0e88\u0ec8\u0eb2\u0e8d\u0ec0\u0e87\u0eb4\u0e99");
  const N_1=tr("Dashboard", "\u0edc\u0ec9\u0eb2\u0e9b\u0eb1\u0e94");
  const N_2=tr("Marketplace", "\u0e95\u0eb0\u0eab\u0ebc\u0eb2\u0e94");
  const N_3=tr("Home", "\u0edc\u0ec9\u0eb2\u0eab\u0ebc\u0eb1\u0e81");
  const C_1=Map((l) => l.$==1?"\ud83c\uddec\ud83c\udde7 ENG":"\ud83c\uddf1\ud83c\udde6 LAO", CurrentLang().View);
  const this_1=new ProviderBuilder("New_1");
  const t=(this_1.h.push(new TextView("currentlangicon", C_1)),this_1);
  const this_2=(t.h.push(EventQ2(t.k, "togglelang", () => t.i, () => {
    CurrentLang().Set(CurrentLang().Get().$==1?English:Lao);
  })),t);
  const this_3=(this_2.h.push(new TextView("navhome", N_3)),this_2);
  const this_4=(this_3.h.push(new TextView("navmarket", N_2)),this_3);
  const this_5=(this_4.h.push(new TextView("navdashboard", N_1)),this_4);
  const this_6=(this_5.h.push(new TextView("navpayments", N)),this_5);
  const this_7=(this_6.h.push(new TextView("homeactive", H)),this_6);
  const this_8=(this_7.h.push(new TextView("marketactive", M)),this_7);
  const this_9=(this_8.h.push(new TextView("dashboardactive", D)),this_8);
  const t_1=(this_9.h.push(new TextView("paymentsactive", P)),this_9);
  const t_2=(t_1.h.push(EventQ2(t_1.k, "gohome", () => t_1.i, () => {
    CurrentPage().Set(Home);
  })),t_1);
  const t_3=(t_2.h.push(EventQ2(t_2.k, "gomarket", () => t_2.i, () => {
    CurrentPage().Set(Market);
  })),t_2);
  const t_4=(t_3.h.push(EventQ2(t_3.k, "godashboard", () => t_3.i, () => {
    CurrentPage().Set(Dashboard);
  })),t_3);
  const this_10=(t_4.h.push(EventQ2(t_4.k, "gopayments", () => t_4.i, () => {
    CurrentPage().Set(Payments);
  })),t_4);
  const b=(this_10.h.push(new Elt("currentview", C)),this_10);
...
function CurrentLang(){
  return _c.CurrentLang;
}
function tr(en, lo){
  return Map((l) => dictEnLao(en, lo, l), CurrentLang().View);
}
function CurrentPage(){
  return _c.CurrentPage;
}
function MarketView(){
  const searchQuery=_c_1.Create_1("");
  const selectedCategory=_c_1.Create_1("All");
  const filteredProducts=Map3((_2, _3, _4) => filter((p_1) =>(_3=="All"||p_1.Category==_3)&&(IsNullOrWhiteSpace(_2)||(p_1.Name.toLowerCase().indexOf(_2.toLowerCase())!=-1||p_1.FarmerName.toLowerCase().indexOf(_2.toLowerCase())!=-1)), _4), searchQuery.View, selectedCategory.View, ProductStore().Observe());
  const E=Doc.EmbedView(Map((lst) => lst.$==0?EmptyState("No products match your search."):Doc.Empty, filteredProducts));
  const P=Doc.Convert((p_1) => {
    const B=tr("Contact Seller", "\u0e95\u0eb4\u0e94\u0e95\u0ecd\u0ec8\u0e9c\u0eb9\u0ec9\u0e82\u0eb2\u0e8d");
    const P_1=formatMoney(p_1.Price);
    const this_8=new ProviderBuilder("New_1");
    const this_9=(this_8.h.push(new Text("productname", p_1.Name)),this_8);
    const this_10=(this_9.h.push(new Text("category", p_1.Category)),this_9);
    const this_11=(this_10.h.push(new Text("price", P_1)),this_10);
    const this_12=(this_11.h.push(new Text("farmername", p_1.FarmerName)),this_11);
    const this_13=(this_12.h.push(new Text("description", p_1.Description)),this_12);
    const this_14=(this_13.h.push(new TextView("buylabel", B)),this_13);
    const t=(this_14.h.push(new Text("btnclass", "btn-primary")),this_14);
    const b_1=(t.h.push(EventQ2(t.k, "buyproduct", () => t.i, () => {
      alert("Contacting "+p_1.FarmerName+" for "+p_1.Name);
    })),t);
    const p_2=CompleteHoles(b_1.k, b_1.h, []);
    const i_1=new TemplateInstance(p_2[1], productcard(p_2[0]));
    let _2=(b_1.i=i_1,i_1);
    return _2.Doc;
  }, filteredProducts);
  const S=tr("Search products or farmers...", "\u0e8a\u0ead\u0e81\u0eab\u0eb2\u0e9c\u0eb0\u0ea5\u0eb4\u0e94\u0e95\u0eb0\u0e9e\u0eb1\u0e99 \u0eab\u0ebc\u0eb7 \u0e8a\u0eb2\u0ea7\u0e81\u0eb0\u0eaa\u0eb4\u0e81\u0ead\u0e99...");
  const M=tr("Discover fresh produce available today.", "\u0e84\u0ebb\u0ec9\u0e99\u0e9e\u0ebb\u0e9a\u0e9c\u0eb0\u0ea5\u0eb4\u0e94\u0e95\u0eb0\u0e9e\u0eb1\u0e99\u0eaa\u0ebb\u0e94\u0ec6\u0e97\u0eb5\u0ec8\u0ea1\u0eb5\u0ec3\u0e99\u0ea1\u0eb7\u0ec9\u0e99\u0eb5\u0ec9.");
  const M_1=tr("Marketplace", "\u0e95\u0eb0\u0eab\u0ebc\u0eb2\u0e94");
  const this_1=new ProviderBuilder("New_1");
  const this_2=(this_1.h.push(new TextView("markettitle", M_1)),this_1);
  const this_3=(this_2.h.push(new TextView("marketsubtitle", M)),this_2);
  const this_4=(this_3.h.push(new VarStr("searchquery", searchQuery)),this_3);
  const this_5=(this_4.h.push(new TextView("searchplaceholder", S)),this_4);
  const this_6=(this_5.h.push(new VarStr("selectedcategory", selectedCategory)),this_5);
  const this_7=(this_6.h.push(new Elt("productcards", P)),this_6);
  const b=(this_7.h.push(new Elt("emptystate", E)),this_7);
  const p=CompleteHoles(b.k, b.h, [["searchquery", 0, null], ["selectedcategory", 0, null]]);
  const i=new TemplateInstance(p[1], marketview(p[0]));
  let _1=(b.i=i,i);
  return _1.Doc;
}
function DashboardView(){
  const newName=_c_1.Create_1("");
  const newPrice=_c_1.Create_1("");
  const newCat=_c_1.Create_1("Vegetables");
  const E=Doc.EmbedView(Map((lst) => lst.$==0?EmptyState("You do not have any active listings."):Doc.Empty, ProductStore().Observe()));
  const M=Doc.Convert((p_1) => {
    const L_3=tr("Remove", "\u0ea5\u0eb6\u0e9a");
    const S=tr("Active", "\u0ec0\u0e9b\u0eb5\u0e94\u0ec3\u0e8a\u0ec9\u0ea2\u0eb9\u0ec8");
    const P_2=formatMoney(p_1.Price);
    const this_21=new ProviderBuilder("New_1");
    const this_22=(this_21.h.push(new Text("productname", p_1.Name)),this_21);
    const this_23=(this_22.h.push(new Text("price", P_2)),this_22);
    const this_24=(this_23.h.push(new TextView("status", S)),this_23);
    const t_1=(this_24.h.push(new TextView("lbldelete", L_3)),this_24);
    const b_1=(t_1.h.push(EventQ2(t_1.k, "removeproduct", () => t_1.i, () => {
      ProductStore().Remove((x) => x.Id==p_1.Id);
    })),t_1);
    const p_2=CompleteHoles(b_1.k, b_1.h, []);
    const i_1=new TemplateInstance(p_2[1], dashboardlistitem(p_2[0]));
    let _2=(b_1.i=i_1,i_1);
    return _2.Doc;
  }, ProductStore().Observe());
  const T_1=Map(String, TotalProductsView());
  const T_2=tr("Products:", "\u0e9c\u0eb0\u0ea5\u0eb4\u0e94\u0e95\u0eb0\u0e9e\u0eb1\u0e99:");
  const T_3=Map(formatMoney, PendingSalesView());
  const T_4=tr("Pending:", "\u0e8d\u0eb1\u0e87\u0e84\u0ec9\u0eb2\u0e87\u0e88\u0ec8\u0eb2\u0e8d:");
  const T_5=Map(formatMoney, TotalSalesView());
  const T_6=tr("Total Earned:", "\u0e8d\u0ead\u0e94\u0e82\u0eb2\u0e8d\u0ea5\u0ea7\u0ea1:");
  const M_1=tr("My Active Listings", "\u0ea5\u0eb2\u0e8d\u0e81\u0eb2\u0e99\u0e9c\u0eb0\u0ea5\u0eb4\u0e94\u0e95\u0eb0\u0e9e\u0eb1\u0e99\u0e82\u0ead\u0e87\u0e82\u0ec9\u0ead\u0e8d");
  const B=tr("List Product", "\u0ea5\u0ebb\u0e87\u0ea5\u0eb2\u0e8d\u0e81\u0eb2\u0e99\u0e9c\u0eb0\u0ea5\u0eb4\u0e94\u0e95\u0eb0\u0e9e\u0eb1\u0e99");
  const L=tr("Category", "\u0e9b\u0eb0\u0ec0\u0e9e\u0e94");
  const P=tr("e.g. 15000", "\u0e95\u0ebb\u0ea7\u0ea2\u0ec8\u0eb2\u0e87: 15000");
  const L_1=tr("Price (LAK)", "\u0ea5\u0eb2\u0e84\u0eb2 (\u0e81\u0eb5\u0e9a)");
  const P_1=tr("e.g. Fresh Mangoes", "\u0e95\u0ebb\u0ea7\u0ea2\u0ec8\u0eb2\u0e87: \u0edd\u0eb2\u0e81\u0ea1\u0ec8\u0ea7\u0e87\u0eaa\u0ebb\u0e94");
  const L_2=tr("Product Name", "\u0e8a\u0eb7\u0ec8\u0e9c\u0eb0\u0ea5\u0eb4\u0e94\u0e95\u0eb0\u0e9e\u0eb1\u0e99");
  const A=tr("Add New Product", "\u0ec0\u0e9e\u0eb5\u0ec8\u0ea1\u0e9c\u0eb0\u0ea5\u0eb4\u0e94\u0e95\u0eb0\u0e9e\u0eb1\u0e99\u0ec3\u0edd\u0ec8");
  const D=tr("Farmer Dashboard", "\u0edc\u0ec9\u0eb2\u0e9b\u0eb1\u0e94\u0e8a\u0eb2\u0ea7\u0e81\u0eb0\u0eaa\u0eb4\u0e81\u0ead\u0e99");
  const this_1=new ProviderBuilder("New_1");
  const this_2=(this_1.h.push(new TextView("dashboardtitle", D)),this_1);
  const this_3=(this_2.h.push(new TextView("addproducttitle", A)),this_2);
  const this_4=(this_3.h.push(new TextView("lblname", L_2)),this_3);
  const this_5=(this_4.h.push(new TextView("phname", P_1)),this_4);
  const this_6=(this_5.h.push(new TextView("lblprice", L_1)),this_5);
  const this_7=(this_6.h.push(new TextView("phprice", P)),this_6);
  const this_8=(this_7.h.push(new TextView("lblcategory", L)),this_7);
  const this_9=(this_8.h.push(new TextView("btnadd", B)),this_8);
  const this_10=(this_9.h.push(new TextView("myproductstitle", M_1)),this_9);
  const this_11=(this_10.h.push(new TextView("totalsaleslabel", T_6)),this_10);
  const this_12=(this_11.h.push(new TextView("totalsalesval", T_5)),this_11);
  const this_13=(this_12.h.push(new TextView("totalpendinglabel", T_4)),this_12);
  const this_14=(this_13.h.push(new TextView("totalpendingval", T_3)),this_13);
  const this_15=(this_14.h.push(new TextView("totalproductslabel", T_2)),this_14);
  const this_16=(this_15.h.push(new TextView("totalproductsval", T_1)),this_15);
  const this_17=(this_16.h.push(new VarStr("inputname", newName)),this_16);
  const this_18=(this_17.h.push(new VarStr("inputprice", newPrice)),this_17);
  const t=(this_18.h.push(new VarStr("inputcategory", newCat)),this_18);
  const this_19=(t.h.push(EventQ2(t.k, "addproduct", () => t.i, () => {
    if(newName.Get()!=""&&newPrice.Get()!=""){
      let c;
      const prf=Number(newPrice.Get());
      const prod=New_1((c=NewGuid(),String(c)), newName.Get(), prf, newCat.Get(), "You", "Newly added product.");
  ...
  const this_20=(this_19.h.push(new Elt("myproductslist", M)),this_19);
  const b=(this_20.h.push(new Elt("emptystate", E)),this_20);
  const p=CompleteHoles(b.k, b.h, [["inputname", 0, null], ["inputprice", 0, null], ["inputcategory", 0, null]]);
  const i=new TemplateInstance(p[1], dashboardview(p[0]));
  let _1=(b.i=i,i);
  return _1.Doc;
}
function PaymentsView(){
  const newBuyer=_c_1.Create_1("");
  const newProdName=_c_1.Create_1("");
  const newAmount=_c_1.Create_1("");
  const newDueDate=_c_1.Create_1(DateFormatter(Date.now()+7*864E5, "yyyy-MM-dd"));
  const E=Doc.EmbedView(Map((lst) => lst.$==0?EmptyState("No payment records."):Doc.Empty, PaymentStore().Observe()));
  const P=Doc.Convert((pym) => {
    const dangerClass=pym.Status.$===0&&Parse(pym.DueDate)<Date.now()?"danger":"";
    const L_4=tr(pym.Status.$===1?"Paid":"Mark Paid", pym.Status.$===1?"\u0e88\u0ec8\u0eb2\u0e8d\u0ec1\u0ea5\u0ec9\u0ea7":"\u0edd\u0eb2\u0e8d\u0ea7\u0ec8\u0eb2\u0e88\u0ec8\u0eb2\u0e8d\u0ec1\u0ea5\u0ec9\u0ea7");
    const L_5=tr("WhatsApp", "WhatsApp");
    const A_1=formatMoney(pym.Amount);
    const this_15=new ProviderBuilder("New_1");
    const this_16=(this_15.h.push(new Text("buyername", pym.BuyerName)),this_15);
    const this_17=(this_16.h.push(new Text("productname", pym.ProductName)),this_16);
    const this_18=(this_17.h.push(new Text("amount", A_1)),this_17);
    const this_19=(this_18.h.push(new Text("duedate", pym.DueDate)),this_18);
    const this_20=(this_19.h.push(new Text("dangerclass", dangerClass)),this_19);
    const this_21=(this_20.h.push(new TextView("lblremind", L_5)),this_20);
    const this_22=(this_21.h.push(new TextView("lblmarkpaid", L_4)),this_21);
    const this_23=(this_22.h.push(new Text("reminddisabled", pym.Status.$===1?"disabled":"")),this_22);
    const t_1=(this_23.h.push(new Text("paiddisabled", pym.Status.$===1?"disabled":"")),this_23);
    const t_2=(t_1.h.push(EventQ2(t_1.k, "markpaid", () => t_1.i, () => {
      if(pym.Status.$===0){
        PaymentStore().Remove((x) => x.Id==pym.Id);
        PaymentStore().Add(New_2(pym.Id, pym.BuyerName, pym.ProductName, pym.Amount, pym.DueDate, Paid, pym.FarmerId));
      }
    })),t_1);
    const b_1=(t_2.h.push(EventQ2(t_2.k, "sendreminder", () => t_2.i, () => {
      if(pym.Status.$===0)globalThis.open("https://wa.me/?text="+encodeURIComponent(((((((_3) =>(_4) =>(_5) =>(_6) =>(_7) => _3("Hello "+toSafe(_4)+", this is a friendly reminder for the payment of "+toSafe(_5)+" for "+toSafe(_6)+" due on "+toSafe(_7)+". Please make the payment soon. Thanks!"))((x) => x))(pym.BuyerName))(formatMoney(pym.Amount)))(pym.ProductName))(pym.DueDate)), "_blank");
    })),t_2);
    const p_1=CompleteHoles(b_1.k, b_1.h, []);
    const i_1=new TemplateInstance(p_1[1], paymentitem(p_1[0]));
    let _2=(b_1.i=i_1,i_1);
    return _2.Doc;
  }, PaymentStore().Observe());
  const B=tr("Create Invoice", "\u0eaa\u0ec9\u0eb2\u0e87\u0ec3\u0e9a\u0ec0\u0e81\u0eb1\u0e9a\u0ec0\u0e87\u0eb4\u0e99");
  const L=tr("Due Date", "\u0ea7\u0eb1\u0e99\u0e81\u0eb3\u0e99\u0ebb\u0e94\u0e88\u0ec8\u0eb2\u0e8d");
  const L_1=tr("Amount (LAK)", "\u0e88\u0eb3\u0e99\u0ea7\u0e99\u0ec0\u0e87\u0eb4\u0e99 (\u0e81\u0eb5\u0e9a)");
  const L_2=tr("Product", "\u0e9c\u0eb0\u0ea5\u0eb4\u0e94\u0e95\u0eb0\u0e9e\u0eb1\u0e99");
  const L_3=tr("Buyer Name", "\u0e8a\u0eb7\u0ec8\u0e9c\u0eb9\u0ec9\u0e8a\u0eb7\u0ec9");
  const A=tr("Create New Invoice", "\u0eaa\u0ec9\u0eb2\u0e87\u0ec3\u0e9a\u0ec0\u0e81\u0eb1\u0e9a\u0ec0\u0e87\u0eb4\u0e99\u0ec3\u0edd\u0ec8");
  const P_1=tr("Track your pending invoices and send WhatsApp reminders to buyers.", "\u0e95\u0eb4\u0e94\u0e95\u0eb2\u0ea1\u0ec3\u0e9a\u0ec0\u0e81\u0eb1\u0e9a\u0ec0\u0e87\u0eb4\u0e99\u0e97\u0eb5\u0ec8\u0e8d\u0eb1\u0e87\u0e84\u0ec9\u0eb2\u0e87 \u0ec1\u0ea5\u0eb0 \u0eaa\u0ebb\u0ec8\u0e87\u0ec1\u0e88\u0ec9\u0e87\u0ec0\u0e95\u0eb7\u0ead\u0e99\u0e9c\u0ec8\u0eb2\u0e99 WhatsApp \u0ec3\u0eab\u0ec9\u0e9c\u0eb9\u0ec9\u0e8a\u0eb7\u0ec9.");
  const P_2=tr("Payments & Reminders", "\u0e81\u0eb2\u0e99\u0e88\u0ec8\u0eb2\u0e8d\u0ec0\u0e87\u0eb4\u0e99 \u0ec1\u0ea5\u0eb0 \u0ec1\u0e88\u0ec9\u0e87\u0ec0\u0e95\u0eb7\u0ead\u0e99");
  const this_1=new ProviderBuilder("New_1");
  const this_2=(this_1.h.push(new TextView("paymentstitle", P_2)),this_1);
  const this_3=(this_2.h.push(new TextView("paymentssubtitle", P_1)),this_2);
  const this_4=(this_3.h.push(new TextView("addpaymenttitle", A)),this_3);
  const this_5=(this_4.h.push(new TextView("lblbuyer", L_3)),this_4);
  const this_6=(this_5.h.push(new TextView("lblproductname", L_2)),this_5);
  const this_7=(this_6.h.push(new TextView("lblamount", L_1)),this_6);
  const this_8=(this_7.h.push(new TextView("lblduedate", L)),this_7);
  const this_9=(this_8.h.push(new TextView("btnaddpayment", B)),this_8);
  const this_10=(this_9.h.push(new VarStr("inputbuyer", newBuyer)),this_9);
  const this_11=(this_10.h.push(new VarStr("inputprodname", newProdName)),this_10);
  const this_12=(this_11.h.push(new VarStr("inputamount", newAmount)),this_11);
  const t=(this_12.h.push(new VarStr("inputduedate", newDueDate)),this_12);
  const this_13=(t.h.push(EventQ2(t.k, "createpayment", () => t.i, () => {
    if(newBuyer.Get()!=""&&newAmount.Get()!=""){
      let c;
      const amt=Number(newAmount.Get());
      const payment=New_2((c=NewGuid(),String(c)), newBuyer.Get(), newProdName.Get(), amt, newDueDate.Get(), Pending, "f1");
      PaymentStore().Add(payment);
      newBuyer.Set("");
      newAmount.Set("");
    }
    else alert("Please fill in Buyer and Amount.");
  })),t);
  const this_14=(this_13.h.push(new Elt("paymentslist", P)),this_13);
  const b=(this_14.h.push(new Elt("emptystate", E)),this_14);
  const p=CompleteHoles(b.k, b.h, [["inputbuyer", 0, null], ["inputprodname", 0, null], ["inputamount", 0, null], ["inputduedate", 0, null]]);
  const i=new TemplateInstance(p[1], paymentsview(p[0]));
  let _1=(b.i=i,i);
  return _1.Doc;
}
function HomeView(){
  const F=tr("Track pending invoices and send convenient WhatsApp reminders.", "\u0e95\u0eb4\u0e94\u0e95\u0eb2\u0ea1\u0ec3\u0e9a\u0ec0\u0e81\u0eb1\u0e9a\u0ec0\u0e87\u0eb4\u0e99\u0e97\u0eb5\u0ec8\u0e8d\u0eb1\u0e87\u0e84\u0ec9\u0eb2\u0e87 \u0ec1\u0ea5\u0eb0 \u0eaa\u0ebb\u0ec8\u0e87\u0ec1\u0e88\u0ec9\u0e87\u0ec0\u0e95\u0eb7\u0ead\u0e99\u0e9c\u0ec8\u0eb2\u0e99 WhatsApp.");
  const F_1=tr("Secure Payments", "\u0e81\u0eb2\u0e99\u0e88\u0ec8\u0eb2\u0e8d\u0ec0\u0e87\u0eb4\u0e99\u0e97\u0eb5\u0ec8\u0e9b\u0ead\u0e94\u0ec4\u0e9e");
  const F_2=tr("Source fresh ingredients directly from the source without middlemen.", "\u0e8a\u0ead\u0e81\u0eab\u0eb2\u0eaa\u0ec8\u0ea7\u0e99\u0e9b\u0eb0\u0e81\u0ead\u0e9a\u0eaa\u0ebb\u0e94\u0ec3\u0edd\u0ec8\u0ec2\u0e94\u0e8d\u0e81\u0ebb\u0e87\u0e88\u0eb2\u0e81\u0ec1\u0eab\u0ebc\u0ec8\u0e87\u0ec2\u0e94\u0e8d\u0e9a\u0ecd\u0ec8\u0ea1\u0eb5\u0e84\u0ebb\u0e99\u0e81\u0eb2\u0e87.");
  const F_3=tr("For Buyers", "\u0eaa\u0eb3\u0ea5\u0eb1\u0e9a\u0e9c\u0eb9\u0ec9\u0e8a\u0eb7\u0ec9");
  const F_4=tr("List your produce easily and reach more buyers locally and nationally.", "\u0ea5\u0ebb\u0e87\u0ea5\u0eb2\u0e8d\u0e81\u0eb2\u0e99\u0e9c\u0eb0\u0ea5\u0eb4\u0e94\u0e95\u0eb0\u0e9e\u0eb1\u0e99\u0e82\u0ead\u0e87\u0e97\u0ec8\u0eb2\u0e99\u0ec4\u0e94\u0ec9\u0ea2\u0ec8\u0eb2\u0e87\u0e87\u0ec8\u0eb2\u0e8d\u0e94\u0eb2\u0e8d \u0ec1\u0ea5\u0eb0 \u0ec0\u0e82\u0ebb\u0ec9\u0eb2\u0ec0\u0e96\u0eb4\u0e87\u0e9c\u0eb9\u0ec9\u0e8a\u0eb7\u0ec9\u0eab\u0ebc\u0eb2\u0e8d\u0e82\u0eb6\u0ec9\u0e99.");
  const F_5=tr("For Farmers", "\u0eaa\u0eb3\u0ea5\u0eb1\u0e9a\u0e8a\u0eb2\u0ea7\u0e81\u0eb0\u0eaa\u0eb4\u0e81\u0ead\u0e99");
  const H=tr("Explore Marketplace", "\u0eaa\u0eb3\u0eab\u0ebc\u0ea7\u0e94\u0e95\u0eb0\u0eab\u0ebc\u0eb2\u0e94");
  const H_1=tr("Directly connecting local farmers with buyers. Fresher produce, fairer prices.", "\u0ec0\u0e8a\u0eb7\u0ec8\u0ead\u0ea1\u0e95\u0ecd\u0ec8\u0e8a\u0eb2\u0ea7\u0e81\u0eb0\u0eaa\u0eb4\u0e81\u0ead\u0e99\u0e97\u0ec9\u0ead\u0e87\u0e96\u0eb4\u0ec8\u0e99\u0e81\u0eb1\u0e9a\u0e9c\u0eb9\u0ec9\u0e8a\u0eb7\u0ec9\u0ec2\u0e94\u0e8d\u0e81\u0ebb\u0e87. \u0e9c\u0eb0\u0ea5\u0eb4\u0e94\u0e95\u0eb0\u0e9e\u0eb1\u0e99\u0eaa\u0ebb\u0e94\u0ec3\u0edd\u0ec8, \u0ea5\u0eb2\u0e84\u0eb2\u0e8d\u0eb8\u0e94\u0e95\u0eb4\u0e97\u0ecd\u0eb2.");
  const H_2=tr("Welcome to AgriConnect", "\u0e8d\u0eb4\u0e99\u0e94\u0eb5\u0e95\u0ec9\u0ead\u0e99\u0eae\u0eb1\u0e9a\u0eaa\u0eb9\u0ec8 AgriConnect");
  const this_1=new ProviderBuilder("New_1");
  const this_2=(this_1.h.push(new TextView("herotitle", H_2)),this_1);
  const this_3=(this_2.h.push(new TextView("herosubtitle", H_1)),this_2);
  const t=(this_3.h.push(new TextView("herocta", H)),this_3);
  const this_4=(t.h.push(EventQ2(t.k, "gomarket", () => t.i, () => {
    CurrentPage().Set(Market);
  })),t);
  const this_5=(this_4.h.push(new TextView("feature1title", F_5)),this_4);
  const this_6=(this_5.h.push(new TextView("feature1desc", F_4)),this_5);
  const this_7=(this_6.h.push(new TextView("feature2title", F_3)),this_6);
  const this_8=(this_7.h.push(new TextView("feature2desc", F_2)),this_7);
  const this_9=(this_8.h.push(new TextView("feature3title", F_1)),this_8);
  const b=(this_9.h.push(new TextView("feature3desc", F)),this_9);
  const p=CompleteHoles(b.k, b.h, []);
  const i=new TemplateInstance(p[1], homeview(p[0]));
  let _1=(b.i=i,i);
  return _1.Doc;
}
function dictEnLao(en, lo, lang){
  return lang.$==1?lo:en;
}
function ProductStore(){
  return _c.ProductStore;
}
function formatMoney(amount){
  return String(amount)+" LAK";
}
function EmptyState(msg){
  const this_1=new ProviderBuilder("New_1");
  const b=(this_1.h.push(new Text("message", msg)),this_1);
  const p=CompleteHoles(b.k, b.h, []);
  const i=new TemplateInstance(p[1], emptystateview(p[0]));
  let _1=(b.i=i,i);
  return _1.Doc;
}
function TotalSalesView(){
  return _c.TotalSalesView;
}
function PendingSalesView(){
  return _c.PendingSalesView;
}
function TotalProductsView(){
  return _c.TotalProductsView;
}
function PaymentStore(){
  return _c.PaymentStore;
}
function createStore(keySelector, initial){
  const model=Create(keySelector, initial);
  return New(() => ofSeq(model.u0076ar.Get()), (items) => {
    model.Set(items);
  }, () => Map(ofSeq, model.v), (item) => {
    model.Append(item);
  }, (predicate) => {
    model.RemoveBy(predicate);
  }, (predicate) =>(updater) => {
    const itemOpt=tryFind(predicate, model.u0076ar.Get());
    if(itemOpt==null)return null;
    else {
      const item=itemOpt.$0;
      model.RemoveBy(predicate);
      return model.Append(updater(item));
    }
  });
}
function initialProducts(){
  return _c.initialProducts;
}
function initialPayments(){
  return _c.initialPayments;
}
...
function productcard(h){
  let n=Some("productcard");
  LoadLocalTemplates("index");
  return h?NamedTemplate("index", n, h):void 0;
}
function marketview(h){
  let n=Some("marketview");
  LoadLocalTemplates("index");
  return h?NamedTemplate("index", n, h):void 0;
}
function dashboardlistitem(h){
  let n=Some("dashboardlistitem");
  LoadLocalTemplates("index");
  return h?NamedTemplate("index", n, h):void 0;
}
function dashboardview(h){
  let n=Some("dashboardview");
  LoadLocalTemplates("index");
  return h?NamedTemplate("index", n, h):void 0;
}
function paymentitem(h){
  let n=Some("paymentitem");
  LoadLocalTemplates("index");
  return h?NamedTemplate("index", n, h):void 0;
}
function paymentsview(h){
  let n=Some("paymentsview");
  LoadLocalTemplates("index");
  return h?NamedTemplate("index", n, h):void 0;
}
function homeview(h){
...
function emptystateview(h){
  let n=Some("emptystateview");
  LoadLocalTemplates("index");
  return h?NamedTemplate("index", n, h):void 0;
}
...
let _c=Lazy((_i) => class $StartupCode_Client {
  ...
  static TotalProductsView;
  static PendingSalesView;
  static TotalSalesView;
  static PaymentStore;
  static ProductStore;
  static initialPayments;
  static initialProducts;
  static CurrentPage;
  static CurrentLang;
  static {
    this.CurrentLang=_c_1.Create_1(English);
    this.CurrentPage=_c_1.Create_1(Home);
    this.initialProducts=ofArray([New_1("p1", "Organic Tomatoes", 25000, "Vegetables", "Somboun", "Fresh organic tomatoes harvested today."), New_1("p2", "Jasmine Rice (10kg)", 150000, "Grains", "Khamla", "Premium grade A jasmine rice from Vientiane province."), New_1("p3", "Mangoes", 30000, "Fruits", "Bounmy", "Sweet yellow mangoes."), New_1("p4", "Free-range Chicken", 45000, "Livestock", "Phouvieng", "Healthy and well-fed local chickens.")]);
    this.initialPayments=ofArray([New_2("pym1", "Restaurant LanXang", "Jasmine Rice (10kg)", 300000, "2026-03-25", Pending, "f1"), New_2("pym2", "Market Vendor A", "Organic Tomatoes", 125000, "2026-03-15", Pending, "f1"), New_2("pym3", "Hotel Vientiane", "Mangoes", 150000, "2026-03-10", Paid, "f1")]);
    this.ProductStore=createStore((p) => p.Id, initialProducts());
    this.PaymentStore=createStore((p) => p.Id, initialPayments());
    this.TotalSalesView=Map((payments) => sumBy((p) => p.Amount, filter((p) => p.Status.$===1, payments)), PaymentStore().Observe());
    this.PendingSalesView=Map((payments) => sumBy((p) => p.Amount, filter((p) => p.Status.$===0, payments)), PaymentStore().Observe());
    this.TotalProductsView=Map((products) => products.Length, ProductStore().Observe());
  }
});
...
function New(Get_1, Set, Observe, Add, Remove, Update){
  return{
    Get:Get_1, 
    Set:Set, 
    Observe:Observe, 
...
function New_1(Id, Name, Price, Category, FarmerName, Description){
  return{
    Id:Id, 
    Name:Name, 
    Price:Price, 
...
function New_2(Id, BuyerName, ProductName, Amount, DueDate, Status, FarmerId){
  return{
    Id:Id, 
    BuyerName:BuyerName, 
...
class ListModel extends Object_1 {
  ...
  constructor(i, _1, _2, _3){
    ...
    if(i=="New"){
      ...
      i="New_3";
      _1=key;
      _2=_c_1.Create_1(ofSeq_1(distinctBy(key, storage.SInit())));
      _3=storage;
    }
    if(i=="New_3"){
      const key_1=_1;
...
let _c_4=Lazy((_i) => class Pervasives {
  static {
    _c_4=_i(this);
  }
  static longMonths;
